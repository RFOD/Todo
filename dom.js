...
function createTaskTab()
{
    ...
    const mainContainerClasses = ['font-bold', 'text-[2rem]', 'text-white', 'p-5', 'px-10', 'flex', 'flex-col']
    ...
    const buttonClasses = ['duration-100', 'w-32','h-10', 'bg-green-600', 'rounded-md', 'text-xl', 'flex', 'justify-center', 'items-center', 'hover:opacity-80']
    buttonContainerClasses.forEach((clasa) => buttonContainer.classList.add(clasa))
...
function createProjectForm(index, title) {
    ...
    if (containerBox !== null) { projectFormSection.removeChild(containerBox); return}
...
if (currTab === 2) {
    ...
    function taskForm(taskTitle, taskDesc) {
        ...
        if (containerForm !== null) { formTaskContainer.removeChild(containerForm); return}
        const containerClasses = ['flex', 'justify-center', 'bg-[#00000020]', 'p-2', 'rounded-lg', 'mb-2']
        ...
        const inputDescClasses = ['px-2', 'w-[80%]', 'row-span-2', 'text-black', 'h-[120px]', 'resize-none', 'rounded-md', 'border-[3px]', 'border-[#00698998]', 'text-lg', 'shadow-lg', 'w-[45%]', 'mb-2', 'focus:outline-none']
        const inputClasses = ['px-2', 'rounded-md', 'text-black', 'border-[3px]', 'border-[#00698998]', 'text-lg', 'shadow-lg', 'w-[80%]', 'h-8', 'mb-2', 'focus:outline-none']
